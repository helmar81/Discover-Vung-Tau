...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Discover Vung Tau" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Main", $$Main, {}, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "H1", $$H1, { "text": "Vung Tau" })} ${maybeRenderHead()}<img src="../images/sunset.webp" alt="wellness=" class="rounded-2xl shadow-xl mb-4  object-cover inline"> <div class="mx-auto max-w-xl text-justify py-3.5"> <p class="text-lg leading-relaxed text-gray-600n justify-around">
...
const $$file = "C:/Users/User/DiscoverVungTau/src/pages/index.astro";
const $$url = "";
