/* empty css                          */
import { e as createAstro, f as createComponent, r as renderTemplate, m as maybeRenderHead, g as addAttribute, h as renderComponent, i as renderHead, j as renderSlot } from '../astro_fCW-vF1L.mjs';
import 'kleur/colors';
import 'clsx';
...
max-w-7xl w-full mx-auto"> <a href="/" class="flex items-center gap-x-4 "> <img src="/heartbeat.png" alt="heartbeat icon"${addAttribute(68, "width")}${addAttribute(64, "height")} class="rounded-2xl aspect-thumbnail object-cover"> <p class="uppercase text-3xl flex items-center gap-x-4 md: text-1xl  text-zinc-900">DISCOVER</p> </a> <ul class="flex gap-x-8"> <li><a href="/about" class="text-teal-900 font-bold">About</a></li> <li><a href="../guide" class="text-teal-900 font-bold">Guide</a></li> <li><a href="/contact" class="text-teal-900 font-bold">Contact</a></li> <li><a href="/wellness" class="text-teal-900 font-bold">Contact</a></li> </ul> </header>`;
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"> <head><meta charset="UTF-8"><meta name="description"${addAttribute(description, "content")}><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"${addAttribute(Astro2.generator, "content")}><meta property="og:image"${addAttribute(image, "content")}><title>${title}</title>${renderHead()}</head> ${renderComponent($$result, "Header", $$Header, {})} <body class="min-h-screen"> ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "Footer", $$Footer, {})} </body></html>`;
...
const $$About = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$About;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "About" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Main", $$Main, {}, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<img class="inline-block h-48 w-28 rounded-full ring-2 ring-white" src="../images/customer.webp" alt=""> <div class="mx-auto max-w-xl text-justify py-3.5"> <p class="text-lg leading-relaxed text-gray-600n justify-around px-px mx-3">
